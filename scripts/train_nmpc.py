...
def main(args):
    ...
    # t_g_bounds = [-3.2, 3.2]
    # v_g_bounds = [0.0, 7.3]
    # v_c_bounds = [v_c_m.min(), v_c_m.max()]
    # x_g_bounds = [x_g_m.min(), x_g_m.max()]
    # y_g_bounds = [y_g_m.min(), y_g_m.max()]
    # t_g_bounds = [t_g_m.min(), t_g_m.max()]
    # v_g_bounds = [v_g_m.min(), v_g_m.max()]
    # beta_bounds = [beta_m.min(), beta_m.max()]
    # angvz_bounds = [angvz_m.min(), angvz_m.max()]
    ...
    # num_regions = (
    #     num_split_v_car * num_split_x_g * num_split_y_g * num_split_t_g * num_split_v_g
    # )
    num_regions = (
        args.num_v
        * args.num_x
